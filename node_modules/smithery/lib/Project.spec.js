...
describe('Testing the Project class', () => {
    it('Project instantiation should fail if no valid configuration is given', () => {
        ...
        chai_1.assert.throws(() => { new Project_1.Project(); });
    });
    describe('Project should be able to read different type of configurations', () => {
        it('Project should be able to instantiate by a directly given configuration', () => {
          ...
          "buildFolder":"build"
            ...
            chai_1.expect(p).not.to.be.undefined;
            mock.restore();
        });
        it('Project should be able to instantiate by a configuration path', () => {
          ...
          "buildFolder":"build"
            ...
            const p = new Project_1.Project({ configPath: 'test.config' });
            chai_1.expect(p).not.to.be.undefined;
            mock.restore();
        });
        it('Project has to throw a error if a given custom configuration is not within the project', () => {
            ...
            chai_1.assert.throws(() => { new Project_1.Project({ configPath: 'test.config' }); }, 'The configuration "test.config" is not within the project folder!!');
            mock.restore();
        });
        ...
        it('All configurations should combine together', () => {
          ...
          "configs":"configurations"  
            ...
            const p = new Project_1.Project({ projectFiles: 'features', configPath: 'test.config' });
            chai_1.expect(p).not.to.be.undefined;
            mock.restore();
        });
    ...
    describe('Project has to throw a error if a combination of configurations is not complete', () => {
        it('custom config is invalid', () => {
            ...
            chai_1.assert.throws(() => { new Project_1.Project({ configPath: 'test.config' }); }, `The used configuration for project "${process.cwd()}" is inclomplete.`);
            mock.restore();
        });
        it('smithery.json is invalid', () => {
            ...
            chai_1.assert.throws(() => { new Project_1.Project(); }, `The used configuration for project "${process.cwd()}" is inclomplete.`);
            mock.restore();
        });
        it('direct config is invalid', () => {
            ...
            chai_1.assert.throws(() => { new Project_1.Project({ projectFiles: 'features', configs: [{ name: 'default', features: ['base'] }] }); }, `The used configuration for project "${process.cwd()}" is inclomplete.`);
            mock.restore();
        });
    });
    it('Project should throw an error if the configs path is invalid', () => {
        ...
        chai_1.assert.throws(() => { new Project_1.Project({ configPath: 'test.config' }); }, 'The build-configurations setup is not given properly');
        mock.restore();
    });
